...
COMMENT ON COLUMN uvv.lojas.produtos.preco_unitario             IS 'Esta é a coluna preço unitário e só aceita números naturais de no máximo 10 caracteres, sendo que o penúltimo e o último caractere ficarão após a vírgula.';
...
COMMENT ON COLUMN uvv.lojas.estoques.produto_id IS 'Esta é a coluna produto_id e é FK da tabela produtos, só aceita números naturais de no máximo 38 caracteres. Não pode ser nula.';
COMMENT ON COLUMN uvv.lojas.estoques.quantidade IS 'Esta é a coluna quantidade, só aceita números naturais de no máximo 38 caracteres. Não pode ser nula.';
